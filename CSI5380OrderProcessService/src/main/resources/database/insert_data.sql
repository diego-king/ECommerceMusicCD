...
"Locked in the Trunk of a Car", "Fifty Mission Cap", "Courage (For Hugh MacLennan)", "At the Hundredth Meridian", "Looking for a Place to Happen",
 and "Fully Completely".', 20.00, 'MCA', 'ROCK', 'image/cd/cd004.jpg');
...
distributor Universal Music Group (on mostly disc two).', 20.00, 'Virgin/ABKCO/Decca', 'ROCK', 'image/cd/cd006.jpg');
