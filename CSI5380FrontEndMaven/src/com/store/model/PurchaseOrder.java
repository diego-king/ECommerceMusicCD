...
public class PurchaseOrder implements Serializable {
    ...
    public PurchaseOrder(long id, long customerId, long shippingAddressId, long billingAddressId, long shippingTypeId,
                         String date, PoStatus status, BigDecimal subTotal, BigDecimal grandTotal, BigDecimal taxTotal,
    ...
    public PurchaseOrder(long id, String date, String status, BigDecimal subTotal, BigDecimal grandTotal, BigDecimal taxTotal,
                         BigDecimal shippingTotal) {
        this.id = id;
        this.date = date;
    ...
    public PurchaseOrder(long id, String date, PoStatus status, BigDecimal subTotal, BigDecimal grandTotal, BigDecimal taxTotal,
            BigDecimal shippingTotal) {
        this.id = id;
        this.date = date;
        this.status = status;
