...
<html lang="en">
    <head>
        ...
        <meta name="description" content="cd store account creation page">
            ...
            <form method="POST" action="account" data-parsley-validate>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="billingProvince" name="billingProvince"
                            data-parsley-trigger="change" required>
                    </div>
                </div>
                <div class="form-row">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="shippingProvince" name="shippingProvince"
                            data-parsley-trigger="change" required>
                    </div>
                </div>
                <div class="form-row">
